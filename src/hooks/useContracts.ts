...
import { CONTRACT_ABIS, RCM_PUNK_CONTRACT_ADDRESSES } from 'config/constants'
...
export const useGetRCMPunksContract = (withSigner = false, withSimpleProvider = true) => {
  return useContract(RCM_PUNK_CONTRACT_ADDRESSES, CONTRACT_ABIS.RCM_PUNKS, withSigner, withSimpleProvider)
}
